    ...
    <html lang="bn" className={`dark ${hindSiliguri.variable} ${inter.variable}`}>
      <body className="min-h-screen flex flex-col bg-[#090d16] text-slate-100 font-sans">
        <LanguageProvider>
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2.5 group">
                ...
                <div className="flex flex-col">
                  <span className="font-extrabold tracking-wider text-lg gradient-title font-display">
                    NAKSHATRA
                  </span>
                  <span className="text-[10px] uppercase tracking-widest text-slate-400 font-semibold -mt-1 font-mono">
          ...
          {/* Footer */}
          <footer className="border-t border-slate-800/80 bg-slate-950/60 py-8 px-4 text-center text-xs text-slate-500 font-mono">
